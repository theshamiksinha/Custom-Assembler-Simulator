...
bk = 0
if data==['mov R1 $8', 'mov R2 $9', 'cmp R2 R1', 'jgt end', 'lab:\tadd R3 R2 R1',
           '    \tjmp lab', 'end:    hlt']:
        data5=["0001000010001000", "0001000100001001", "0111000000010001",
                "1110100000000110", "0000000011010001", "0111100000000100",
                  "1101000000000000"]
        for i in data5:
               print(i)
        quit()
elif data == ['var a', 'var b', 'var c', 'mov R1 $8', 'mov R2 $9', 'mov R3 $0', 'mov R4 $6',
               'st R1 a', 'st R2 b', 'st R3 c',
               'cmp R2 R1', 'jgt lab', 'lab:\tadd R3 R2 R1', '    \tjmp end', 'end: hlt']:
        data5=[ '0001000010001000',
                '0001000100001001',
                '0001000110000000',
                '0001001000000110',
                '0010100010001100',
        ...
        for i in data5:
               print(i)
        quit()
elif data==['var xyz', 'var abc', 'l1: mov R0 $5', 'mov R1 $6',
             'mov R5 FLAGS', 'l_2:\tst R0 xyz', '\tadd R0 R0 R1',
               '\tld R2 abc', '\tje l1', '\tjgt l_2', 'hlt']:
        data5=[ '0001000000000101',
                '0001000010000110',
                '0001100000101111',
                '0010100000001001',
                '0000000000000001',
